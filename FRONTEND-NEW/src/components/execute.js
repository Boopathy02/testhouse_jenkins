          ...
          <div className={styles.tagFilterBox}>
            ...
            <div className={styles.tagDropdownList}>
              {[
                ...
                <div
                  key={section.id}
                  className={`${styles.tagDropdown} ${styles[`tagDropdown${section.id.charAt(0).toUpperCase()}${section.id.slice(1)}`]}`}
                >
                  <button
                    type="button"
            ...
            <div className={styles.executionPlan}>
              ...
              {totalPages > 1 && (
                <div className={styles.executionPagination}>
                  <button
                    type="button"
                    className={`${styles.executionPageButton} ${styles.executionPagePrev}`}
                  ...
                  <button
                    type="button"
                    className={`${styles.executionPageButton} ${styles.executionPageNext}`}
